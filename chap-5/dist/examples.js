...
function findAvailableCreaturesByCapability(capability) {
    ...
    return creatures.filter(creature => creature.available && creature.capabilities.includes(capability));
}
// --- Using our typed functions ---
console.log("--- Available Flying Creatures ---");
const flyingCreatures = findAvailableCreaturesByCapability(creature_1.CreatureCapability.FLYING);
