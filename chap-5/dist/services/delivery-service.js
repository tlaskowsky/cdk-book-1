...
class DeliveryService {
    ...
    createDeliveryRequest(packageId) {
        ...
        const newDelivery = {
            ...
            status: delivery_1.DeliveryStatus.REQUESTED,
    ...
    updateDeliveryStatus(id, status, failureReason) {
        ...
        if (delivery) {
            ...
            if (status === delivery_1.DeliveryStatus.FAILED && failureReason) {
...
class PriorityDeliveryService extends DeliveryService {
    ...
    createDeliveryRequest(packageId) {
        ...
        const newDelivery = {
            ...
            status: delivery_1.DeliveryStatus.ASSIGNED, // Set status to assigned
            requestTime: new Date(),
...
exports.PriorityDeliveryService = PriorityDeliveryService;
